      ...
      <div className='flex flex-col md:flex-row items-center justify-center mx-auto max-w-screen-xl mt-10 px-4 md:px-8'>
        ...
        <div className='text-center md:text-left'>
          ...
          <div className='flex justify-center md:justify-end'>
            <Link to="/play">
              <button className='bg-black text-white dark:bg-white dark:text-black font-semibold px-6 py-2 border-2 border-transparent dark:border-white rounded-md hover:bg-slate-700 dark:hover:bg-gray-200 transition-colors duration-300'>
                Play Now
              </button>
            </Link>
          </div>
